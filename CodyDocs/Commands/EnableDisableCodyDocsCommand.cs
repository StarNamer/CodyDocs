...
namespace CodyDocs.Commands
{
    ...
    internal sealed class EnableDisableCodyDocsCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("6d5148e8-ba37-40e1-ae9d-6f9e7caf4033");
        ...
        private EnableDisableCodyDocsCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            var command = new MenuCommand(this.Execute, menuCommandID);
        ...
        {
            // Switch to the main thread - the call to AddCommand in EnableDisableCodyDocsCommand's constructor requires
            // the UI thread.
